...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] =
{
    ...
    { TEXT_CreateIndirect, "COOL\nTO", ID_TEXT_COOLTO, 354, 110, 100, 80, 0, 0x64, 0 },
    { TEXT_CreateIndirect, "HEAT\nTO", ID_TEXT_HEATTO, 38, 110, 70, 80, 0, 0x64, 0 },
...
static float cool_to, heat_to, fromHome;
...
static void _cbDialog(WM_MESSAGE * pMsg)
{
    ...
    case WM_INIT_DIALOG:
        ...
        if (metric)
        {
            WM_MoveTo(hItem, 136, 65);
        }
        else
        {
            WM_MoveTo(hItem, 150, 65);
        }
        //
        ...
        if (metric)
        {
            WM_MoveTo(hItem, 136, 190);
        }
        else
        {
            WM_MoveTo(hItem, 150, 190);
        }
        //
        ...
        if (metric)
        {
            WM_MoveTo(hItem, 296, 66);
        }
        else
        {
            WM_MoveTo(hItem, 290, 66);
        }
        //
        ...
        if (metric)
        {
            WM_MoveTo(hItem, 296, 191);
        }
        else
        {
            WM_MoveTo(hItem, 290, 191);
        }
        //
